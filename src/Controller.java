...
public class Controller {
    private final Model snakeGameModel;
    private final View snakeGameView;
    private final NorthGamePanel northpanel;
    private final SouthGamePanel southpanel;

    private Timer gameTimer = null;

    public Controller(Model snakeGameModel, View snakeView, NorthGamePanel npanel, SouthGamePanel spanel){
